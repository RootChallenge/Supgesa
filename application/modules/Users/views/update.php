	...
	<div class = "col-md-offset-4 col-md-4 col-md-offset-4">
		<?php echo form_open('', array('class' => 'well'));?>
			...
			<div class = "form-group">
				...
				echo form_dropdown('users_permission', $permissions, set_value('users_permission')?set_value('users_permission'):$users->users_permission, array('class' => 'form-control tooltip-input', 'required' => true));
				?>
